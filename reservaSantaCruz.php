										...
										<div class="borde">
											...
											<form action="datos.php" method="POST" >
													...
													<div class="contenedor">
														...
														<input type="text" name="destino" id="fullname" class="form-control" value="santa Cruz" required="" readonly>
													</div>
												...
												<input type="date" id="fecha" name="fecha"
													...
													<div class="contenedor">
														...
														<input type="text" name="precio" id="fullname" class="form-control" value="200" required="" readonly>
													</div>
