											...
											<form action="datos.php" method="POST" >
                                                ...
                                                <div >
													<div >
														...
														<input type="text" name="ci" id="fullname" class="form-control" value="Tarija" required="" readonly>
													</div>
												</div>
                                                ...
                                                <div >
													<div >
														...
														<input type="text" name="ci" id="fullname" class="form-control" value="150" required="" readonly>
													</div>
												</div>
